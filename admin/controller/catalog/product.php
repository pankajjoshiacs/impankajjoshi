...
class ControllerCatalogProduct extends Controller {
	private $error = array(); 
  	...
  	private function getForm() {
		...
		if (isset($this->error['pack'])) {
			$this->data['error_pack'] = $this->error['pack'];
		} else {
			$this->data['error_pack'] = '';
		}		
		...
		if (isset($this->request->post['pack'])) {
      		$this->data['pack'] = $this->request->post['pack'];
    	} elseif (isset($product_info)) {
			$this->data['pack'] = $product_info['pack'];
		} else {
      		$this->data['pack'] = '';
    	}
  	...
  	private function validateForm() { 
		...
		if ($this->request->post['weight'] == '' or !is_numeric($this->request->post['weight']) ) {
      		$this->error['weight'] = $this->language->get('error_weight');
    	}
		
		if ($this->request->post['pack'] == '') {
      		$this->error['pack'] = $this->language->get('error_pack');
    	}
