...
<div class="box">
  ...
  <div class="content">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <input type="hidden" name="measurement_class_id" value="1"/>
      ...
      <div id="tab_data">
        <table class="form">
          ...
          <tr>
            <td><span class="required">*</span> <?php echo $entry_pack; ?></td>
            <td>
              <select name="pack">
                <option value="">-- Select pack --</option>
                <option value="dry" <?php if ($pack == 'dry') { ?>selected="selected"<?php } ?>>Dry pack</option>
                <option value="cool" <?php if ($pack == 'cool') { ?>selected="selected"<?php } ?>>Cool pack</option>
              </select>
              <?php if ($error_pack) { ?>
              <span class="error"><?php echo $error_pack; ?></span>
              <?php } ?>
