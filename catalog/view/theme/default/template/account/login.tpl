...
<!--CONTAINER STARTS HERE-->
  <div class="ContainHolder" style="background:#FFFFFF;">
  <div class="full-side" style="padding:15px 10px;">
  <div class="ContRightBotTitle" style="width:950px;">
        <div class="LtstLeft"></div>
        <div class="Ltstmed" style="width:900px;"><?php echo $heading_title; ?></div>
      ...
      <div style="float: right; display: inline-block; width: 49%;"><b style="margin-bottom: 2px; display: block;"><?php echo $text_returning_customer; ?></b>
        <div style="background: #F7F7F7; border: 1px solid #DDDDDD; padding: 10px; min-height: 210px;">
          <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="login">
            ...
            <input type="text" name="email" class="largeText" />
            <br />
            <br />
            <b><?php echo $entry_password; ?></b><br />
            <input type="password" name="password" class="largeText" />
            <br />
