...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['about'] = $this->url->https('information/information&information_id=4');
		$this->data['product'] = $this->url->https('product/products');
		$this->data['policy'] = $this->url->https('information/information&information_id=3');
		$this->data['special'] = $this->url->https('product/special');
		$this->data['contact'] = $this->url->https('information/contact');
		...
		$this->data['cart_count'] = count($cart_items);
		$this->data['cart_sub_total'] = $this->currency->format($this->cart->getTotal());
		$this->data['cart_href'] = $this->model_tool_seo_url->rewrite($this->url->http('checkout/cart'));
		// end cart count //
