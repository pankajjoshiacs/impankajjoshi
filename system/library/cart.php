...
final class Cart {
  	...
  	public function getProducts() {
		...
		$wt_classes = $query->rows;
		$weightClasses = array();
		foreach($wt_classes as $wt_class){
			$weightClasses[$wt_class['weight_class_id']] = $wt_class['unit'];
		}
		// product weight
    	...
    	foreach ($this->session->data['cart'] as $key => $value) {
			...
			if ($product_query->num_rows) {
				...
				$weight_unit = isset($weightClasses[$product_query->row['weight_class_id']]) ? $weightClasses[$product_query->row['weight_class_id']] : '';
				
				$product_weight = $product_query->row['weight'].' '. $weight_unit;
